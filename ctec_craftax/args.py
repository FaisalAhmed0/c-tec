...
def etd_ppo_args(sys):
    ...
    parser.add_argument("--`agent`", type=str, default="etd_ppo")
    parser.add_argument(
    ...
    parser.add_argument("--save_policy", type=int, default=1)
    # parser.add_argument("--save_policy", int, default=1)
    ...
    parser.add_argument("--similarity_measure", type=str, default="mrn")
    parser.add_argument("--contrastive_loss", type=str, default="symmetric_infonce")
    parser.add_argument("--logsumexp_penalty_coeff", type=float, default=0.0)
    parser.add_argument("--use_single_sample", type=int, default=0)
    ...
    parser.add_argument("--use_td_crl_loss", type=float, default=0)
    ...
    parser.add_argument("--model", type=str, default="etd_ppo_rnn")
...
def ctec_ppo_args(sys):
    ...
    parser.add_argument("--geom_trunc", type=int, default=1024)
    parser.add_argument("--relative_scale", type=float, default=0.01)
    parser.add_argument("--model", type=str, default="crl_ppo")
    parser.add_argument("--run_name_suffix", type=str, default="")
...
def ctec_rnn_args(sys):
    ...
    parser.add_argument("--lr", type=float, default=2e-4)
    parser.add_argument("--num_steps", type=int, default=64)
    parser.add_argument("--`agent`", type=str, default="ctec_ppo_rnn")
    parser.add_argument("--update_epochs", type=int, default=4)
    parser.add_argument("--num_minibatches", type=int, default=8)
    parser.add_argument("--gamma", type=float, default=0.99)
    parser.add_argument("--gae_lambda", type=float, default=0.8)
...
def etd_rnn_args(sys):
    parser = argparse.ArgumentParser()
    parser.add_argument("--env_name", type=str, default="Craftax-Classic-Symbolic-v1")
    parser.add_argument("--backend", type=str, default=None)
    parser.add_argument("--include_goal_in_obs", type=int, default=0) 
    parser.add_argument("--agent", type=str, default="etd_ppo_rnn")
    parser.add_argument("--model", type=str, default="etd_ppo_rnn")
    parser.add_argument("--run_name_suffix", type=str, default="")
    parser.add_argument(
        "--num_envs",
    ...
    parser.add_argument(
        "--use_normalize_repr", action=argparse.BooleanOptionalAction, default=False
    )
    parser.add_argument(
        "--fix_temp", action=argparse.BooleanOptionalAction, default=False
    )
