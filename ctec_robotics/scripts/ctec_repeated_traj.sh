...
TRACK="--track"
WANDB_PROJECT_NAME="ctec_same_trajectory_negatives"
...
visualize_reward="--no-visualize_reward"
...
REPS_DIMS=(64)
USE_COMPLETE_FUTURE_STATE_VALUES=("--no-use_complete_future_state" "--use_complete_future_state")
